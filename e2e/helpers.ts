...
export const clickCanvas = async (page: Page, x: number, y: number): Promise<void> => {
...
export const switchMode = async (page: Page, mode: 'point' | 'polygon' | 'move' | 'delete'): Promise<void> => {
